# 高速上云服务或物理专线网络性能测试方法 {#concept_fnm_bkb_ydb .concept}
...
-   完成高速上云服务或物理专线的接入和路由配置，本地IDC与阿里云必须有删除的内容:VPC 高速上云服务或物理专线连通。

    -   如果是高速上云服务，需要VBR和VPC加入同一个云企业网CEN实例，并购买或设置相应的带宽包。
